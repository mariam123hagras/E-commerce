    ...
    <footer className="border-t py-12 ">
        ...
        <div>
          ...
          <p className="text-gray-500 mb-4">
            Be the first to hear about new products, exclusive events , and online offers </p>  
            <p className="font-medium text-sm text-gray-600 mb-6" >
                Sign up and get 10% off your first order!
            </p>
            {/* Newsletter form */}
            <form className="flex w-full md:w-[20rem] ">
        ...
        {/* Support Links */}
         <div>
          ...
          <ul className="space-y-2 text-gray-600">
               <li>
                <Link to="#" className="hover:text-gray-600 transition-colors"  >Contanct US</Link>
               </li>
                 <li>
